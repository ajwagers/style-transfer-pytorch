...
******************************************************************************************************************************************************************************* 
THIS IS NOT MY WORK.  I AM INTERESTED IN UNDERSTANDING IT AND MAKING IT MY OWN.  I ALSO WOULD LIKE TO RUN IT LOCALLY RATHER THAN THROUGH COLAB (like here possibly https://pythonrepo.com/repo/nerdyrodent-VQGAN-CLIP-python-deep-learning) IF THAT IS EVEN POSSIBLE WITH MY HARDWARE.  (another resource https://pythonawesome.com/a-feed-forward-vqgan-clip-model-with-python/)
*******************************************************************************************************************************************************************************
